...
public class Kafka010Example {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> stream = env.addSource(new FlinkKafkaConsumer09<>("batch", new SimpleStringSchema(), properties));

//		FlinkKafkaProducer08<KafkaEvent> producer=new FlinkKafkaProducer08<>(
//				"topic",
